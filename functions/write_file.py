...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Writes given content to a specified file, creating parent directories if needed; the file must be within the working directory and not a directory itself.",
